...
var SaleTicketDetailSum = require('./SaleTicketDetailSum.js');
...
module.exports = React.createClass({
	getInitialState: function () {
		return {
			data: zn.store.post('/oa/sale/getProductList', {
			...
			items: [
				...
				{ title: '备注', name: 'zn_note', width: 480 },
	...
	__downloadAsExcel: function (){
		zn.react.downloadURL(zn.http.fixURL('/oa/sale/downloadProductList?wfinstance=' + this.props.request.search.wf_id));
	},
	...
	render:function(){
		return (
			<zn.react.Page title='销售单据列表' className="zn-plugin-workflow-wf-my" toolbarItems={this.state.toolbarItems}>
				<SaleTicketDetailSum wf_id={this.props.request.search.wf_id} />
				<zn.react.PagerView
					view="Table"
