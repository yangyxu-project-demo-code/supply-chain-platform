...
module.exports = React.createClass({
	...
	getInitialState: function () {
		return {
			...
			toolbarItems: [
				{ text: '退换货单据列表', status: 'warning', name: 'list', icon: 'fa-list' }
			]
		}
	},
	__onToolbarClick: function (item){
		switch (item.name) {
			case 'list':
				zn.react.session.relativeJump('/workorder.sale.service.ticket.detail.list');
				break;
		}
	},
	...
	render:function(){
		return (
			<zn.react.Page title='退换货售后' className="zn-plugin-workflow-wf-my"
