...
module.exports = React.createClass({
	...
	getInitialState: function () {
		return {
			...
			toolbarItems: [
				{ text: '发起调拨', name: 'add', icon: 'fa-exchange' }
			]
		}
	},
	...
	__createInstance: function (index){
		zn.react.session.relativeJump('/workorder.create.allocate.ticket');
		return false;
	},
	...
	render:function(){
		return (
			<zn.react.Page title='仓库调拨' className="zn-plugin-workflow-wf-my"
