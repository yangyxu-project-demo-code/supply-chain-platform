...
module.exports = React.createClass({
	getInitialState: function () {
		return {
			data: zn.store.post('/oa/sale/pagingOtherSaleServices', {
	...
	__downloadAsExcel: function (){
		...
		zn.react.downloadURL(zn.http.fixURL('/oa/sale/downloadOtherSaleServices?' + zn.querystring.stringify(_params)));
	},
	__cancel: function (){
	...
	render:function(){
		return (
			<zn.react.Page title='其他售后单据列表' className="zn-plugin-workflow-wf-my oa-admin-user-customer-order-details" toolbarItems={this.state.toolbarItems}>
