...
var CustomerInvoiceInfo = require('../user/CustomerInvoiceInfo.js');
...
module.exports = React.createClass({
	getInitialState: function () {
		return {
			...
			items: [
				...
				{ title: '对公客户', name: 'customer', width: 240, filter: { type: zn.CustomerSearcher, opts: ['='] }  },
	...
	render:function(){
		return (
			<zn.react.Page title="客户发票管理" className="zn-plugin-workflow-wf-my oa-admin-user-customer-order-details">
