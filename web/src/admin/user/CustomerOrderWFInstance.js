...
module.exports = React.createClass({
	getInitialState: function () {
		return {
			data: zn.store.post('/oa/customer/orders', { customer: this.props.customer }),
			items: [
				{ title: '单号', name: 'code', width: 150, filter: { type: 'Input', opts: ['like'] } },
				{ title: '状态', name: 'state', width: 80 },
				{ title: '采购商(客户)', name: 'customer_convert', width: 200 },
				{ title: '出库仓', name: 'out_warehouse_convert', width: 120 },
				...
				{ title: '操作时间', name: 'zn_modify_time', width: 140, filter: { type: 'Input', opts: ['like'] } },
